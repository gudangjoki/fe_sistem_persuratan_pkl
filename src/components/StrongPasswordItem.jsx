        ...
        <div className="flex mb-2">
          <div className="flex-1">
            <input
              ...
              className="block w-full px-4 py-3 text-sm border-gray-200 rounded-md focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
        ...
        <div id="hs-strong-password-hints" className="mb-3">
          ...
          <ul className="space-y-1 text-sm text-gray-500">
            <li
              ...
              className="flex items-center hs-strong-password-active:text-teal-500 gap-x-2"
            >
