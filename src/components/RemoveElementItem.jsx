...
export default function RemoveElementItem(props) {
    ...
    return (
      ...
      >
        <div className="inline-flex items-center justify-between px-4 py-3 bg-gray-100 border-b rounded-t-xl md:py-4 md:px-5 dark:bg-gray-800 dark:border-gray-700">
          <h3 className="font-semibold text-gray-800 dark:text-white">
            Remove element card
          </h3>
          <button
            type="button"
            className="inline-flex items-center justify-center w-4 h-4 text-sm text-gray-400 rounded-lg hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800"
        ...
        <div className="p-4 text-center md:py-10 md:px-5">
          <svg
